...
const showCards = () => {
  ...
  volunteershipcards.forEach(
    ({ title, cardImage, description, open_link }) =>
      (output += `        
      <div class="card volunteerCard" data-aos="fade-down" data-aos-easing="linear" data-aos-delay="100" data-aos-duration="600" style="height: 550px;width:400px" onclick="window.location='${open_link}';">
